  ...
  <div class="container">
    <header>
      <ul>
        ...
        <li class="nav_list_item"><a href="#contact" class="scrollOnClick"><i class="fa fa-address-book" aria-hidden="true"></i> Contact</a></li>
        <li class="nav_list_item"><a href="#work" class="scrollOnClick"><i class="fa fa-laptop" aria-hidden="true"></i> Mijn werk</a></li>
        <li class="nav_list_item"><a href="#about" class="scrollOnClick"> <i class="fa fa-user" aria-hidden="true"></i> Over mij</a></li>
        <li class="nav_list_item active"><a href="#top" class="scrollOnClick"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
        <a href="#top" class="scrollOnClick"><img  src="afb/logo.png" alt="Credit to Rowin Schmidt"  id="logo"></a>
      </ul>
...
<a href="#top" class="scrollOnClick">Home</a>
<a href="#about" class="scrollOnClick">Over mij</a>
<a href="#work" class="scrollOnClick">Mijn werk</a>
<a href="#contact" class="scrollOnClick">Contact</a>
</div>
...
<span id="sidebarOpen"
 onclick="openNav()">&#9776; </span>
    ...
    <div class="about__container">
      <div id="about">
        <h1>Over mij</h1>
        <div class="about__avatar"><img alt="Kan afbeelding niet weergeven" src="afb/profielfoto.jpg"></div>
        ...
        <p class="about__text2">Ik studeer media | web development aan het Mediacollege in Amsterdam en heb ervaring opgedaan in
          ...
          <a href="#work" class="scrollOnClick"><span>hier</span></a><br><br> Verder.. <strong>Wie ben ik zelf?</strong>
    ...
    <div id="work">
      ...
      <div class="work__container">
        ...
        <div class="projecten">
          <img alt="Kan afbeelding niet weergeven" src="afb/redactieadmiraal.png" class="work__image">
          <div class="foreground">

            <div class="plus__button"><a class="fa fa-plus  fa-5x toggleModalButton" aria-hidden="true"></a></div>
          </div>
                  ...
                  <div class="project__text"><br>
                    ...
                    <hr><br>
                      <div class="skills__images">
                        <img alt="Kan afbeelding niet weergeven" src="afb/html5.png">
                        <img alt="Kan afbeelding niet weergeven" src="afb/css.png">
                        <img alt="Kan afbeelding niet weergeven" src="afb/javascript.png">
                        <img alt="Kan afbeelding niet weergeven" src="afb/php.png"></div>
        ...
        <div class="projecten">
          ...
          <img alt="Kan afbeelding niet weergeven" src="afb/picShare.jpg" class="work__image">
                <div class="foreground">
                    ...
                    <p>Project <a
                      ...
                      <hr><br>
                        <div class="skills__images">
                          ...
                          <img alt="Kan afbeelding niet weergeven" src="afb/css.png">
                          <img alt="Kan afbeelding niet weergeven" src="afb/javascript.png">
                          <img alt="Kan afbeelding niet weergeven" src="afb/php.png">
                        </div> </div>
                    <br><br>
                  </div>
                </div>
            ...
            <div class="projecten">
              ...
              <img alt="Kan afbeelding niet weergeven" src="afb/thewall.png" class="work__image"></a>
              <div class="foreground">
                <div class="plus__button"><a class="fa fa-plus  fa-5x toggleModalButton" aria-hidden="true"></a></div>
              </div>
              <div class="modal myModal">
            ...
            <div class="projecten">
              <img alt="Kan afbeelding niet weergeven" src="afb/myBand.jpg" class="work__image">
              <div class="foreground">
              ...
              <div class="modal myModal">
                <div class="modal-content">
                  <span class="close"><div class="outer">
                    ...
                    <div class="modal__header">
                  <p>Volgende project..... <a
                    href=""
                    target="_blank"><span id=""></span></a></p>
                    </div>
                    <div class="project__text"><br>
                      <p>
                      <br><br>
          ...
          <div class="work__container2">
            ...
            <div class="projecten">
              <img alt="Kan afbeelding niet weergeven" src="afb/randomzin.jpg" class="work__image">
              <div class="foreground">
            ...
            <div class="projecten">
              <img alt="Kan afbeelding niet weergeven" src="afb/ourhouse.png" class="work__image">
              <div class="foreground">
            ...
            <div class="projecten">
              <img alt="Kan afbeelding niet weergeven" src="afb/bmicalc.png" class="work__image">
              <div class="foreground">
                  ...
                  <span class="close"><div class="outer">
                    ...
                    <div class="modal__header">
                      ...
                      <div class="project__text"><br>
                        ...
                        <hr><br>
                          <div class="skills__images">
                            <img alt="Kan afbeelding niet weergeven" src="afb/html5.png"> <img src="afb/css.png"> <img src="afb/javascript.png"> <img src="afb/php.png">
                          </div>   </div>
                </div>
              </div>
        ...
        <div id="contact">
          ...
          <div class="contact__container">
            ...
            <div class="contact__block1">
              <p>Contacteer mij op dit mailadres: <a href="mailto:24011@ma-web.nl?Subject=Hello%20again"
            ...
            <div class="contact__block1">
              ...
              <a href="https://www.facebook.com/patrick.frumau" class="fa fa-facebook"></a>
              <a href="https://twitter.com/PatrickFrumau" class="fa fa-twitter"></a>
              <a href="https://plus.google.com/u/0/114010166916106078073" class="fa fa-google-plus"></a>

              <br><br>
              <p>Ik gebruik linkedin voor zakelijke contacten;</p><br>
              <a href="https://www.linkedin.com/in/patrick-frumau-2a692214b/" class="fa fa-linkedin"></a>

              <p>Github voor code:</p> <br>
              <a href="https://github.com/Pariek6" class="fa fa-github"></a>
